...
// We also put: this.url = url.replace("uri=", ""); Because we want to make us replace what we get as url, which is ur: uri: /client/**, to just url: that is, an empty space as shown.
